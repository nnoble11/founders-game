    ...
    <section className="mx-auto max-w-5xl px-6 py-32 md:py-44" aria-label="Game 001 — San Francisco">
      <Reveal>
        <p className="max-w-3xl text-xl leading-relaxed text-bone/75 md:text-2xl">
          August 2026 · 18 seats. A penthouse with panoramic views.
          Professional dealers. Dinner, an open bar, and $1,000 to first
          place. Location shared with confirmed seats.
        </p>
      </Reveal>
      <Reveal delay={0.1}>
